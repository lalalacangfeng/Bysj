                        ...
                        <tbody>
	                   	<c:forEach items="${vedios }" var="vedio">
                        	<tr class="gradeX">
	                            ...
	                            <td><img alt="image" src="${vedio.picture }" style="height:50%; width:30%" /></td>	                            	
	                            <td><a href="admin/media/vedio.jsp?id=${vedio.vid}&src=${vedio.src}&pict=${vedio.picture}">
	                            	<c:out value="${vedio.name}"/></a></td>
	                            <td><c:out value="${vedio.descript}"/></td>
	                            <td><a href="admin/media?action=del&id=${vedio.vid }"><i class="fa fa-close"> 删除</a></td>
                            </tr>
	                   	</c:forEach>
                        </tbody>
						<tfoot>
