...
public class MediaDaoImpl implements MediaDao {
	...
	public int saveMedia(Media media) throws Exception {
		int result = 0;
		String sql = "insert into media(name,src,picture,author,descript)"
				+ " values(?,?,?,?,?)";
		pstmt = this.con.prepareStatement(sql);
		pstmt.setString(1, media.getName());
		pstmt.setString(2, media.getSrc());
		pstmt.setString(3, media.getPicture());
		pstmt.setString(4, media.getAuthor());
		pstmt.setString(5, media.getDescript());
		System.out.println(" media.getName()："+media.getName()+" media.getSrc():"+media.getSrc());
